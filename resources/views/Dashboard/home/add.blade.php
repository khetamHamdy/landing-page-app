                            ...
                            <div class="card-body p-0">
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    <div class="col-xl-12 col-xxl-10">
                                        ...
                                        <form class="form" action="{{route('home_store')}}" method="post"
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-xl-9">
                                                    ...
                                                    <div class="my-5 step" data-wizard-type="step-content"
                                                        ...
                                                        <h5 class="text-dark font-weight-bold mb-10">Home Details:</h5>
                                                        <!--begin::Group-->
                                                            ...
                                                            <div class="col-lg-9 col-xl-9">
                                                                <div class="image-input image-input-outline"
                                                                    ...
                                                                    <div class="image-input-wrapper"
                                                                         style="background-image: url(dashboard/media/users/100_4.jpg)"></div>
                                                                    <label
                                                            ...
                                                            <div class="tab-content" id="myTabContent">
                                                                @foreach (config('app.languages') as $key => $lang)
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label
                                                                                class="col-xl-3 col-lg-3 col-form-label">Google
                                                                                App
                                                                                Link </label>
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                <input
