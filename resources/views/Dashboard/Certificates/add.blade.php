<x-dashboard-layout>    <!--begin::Entry-->
                            ...
                            <div class="card-body p-0">
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    <div class="col-xl-12 col-xxl-10">
                                        ...
                                        <form class="form" action="{{route('certificates.store')}}" method="post"
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div
                                                                    ...
                                                                    <div class="image-input-wrapper"
                                                                         style="background-image: url(dashboard/media/users/100_3.jpg)"></div>
                                                                    <label
                                                            ...
                                                            <div class="tab-content" id="myTabContent">
                                                                @foreach (config('app.languages') as $key => $lang)
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="form-group row">
                                                                            <label
                                                                                class="col-xl-3 col-lg-3 col-form-label">Title Job</label>
                                                                            <div class="col-lg-9 col-xl-9">
                                                                                <input
                                                                                    class="form-control form-control-solid form-control-lg"

                                                                                    name="{{$key}}[title_job]" type="text"/>
                                                                            </div>
                                                                        </div>
                                                                        <!--end::Group-->
