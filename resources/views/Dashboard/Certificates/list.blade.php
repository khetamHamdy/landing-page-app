    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <span class="text-muted font-weight-bold mr-4">{{__('Certificates')}} </span>
                @can('certificates.create')
                    <a href="{{route('certificates.create')}}" class="btn btn-light-warning font-weight-bolder btn-sm">{{__('Add')}}  </a>
                @endcan
                <!--end::Actions-->
            </div>
            <!--end::Info-->
                        ...
                        <div class="card card-custom gutter-b card-stretch">
                            ...
                            <div class="card-body text-center pt-4">
                                ...
                                @can('certificates.delete')
                                    <form action="{{route('certificates.destroy' , $data)}}" method="POST">
                                        @csrf
                                        @method('delete')
                                        <br>
                                        <button type="submit"
                                ...
                                @can('certificates.update')
                                    <a href="{{route('certificates.edit' , $data)}}">
                                        <button
