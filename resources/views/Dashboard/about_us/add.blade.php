                            ...
                            <div class="card-body p-0">
                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                    ...
                                    <div class="col-xl-12 col-xxl-10">
                                        <!--begin::Wizard Form-->
                                        <form class="form" action="{{route('about_store')}}" method="post"
                                                            ...
                                                            <div class="col-lg-9 col-xl-6">
                                                                <div
                                                                    ...
                                                                    <div class="image-input-wrapper"
                                                                         style="background-image: url(dashboard/media/users/100_5.jpg)"></div>
                                                                    <label
                                                                ...
                                                                @foreach (config('app.languages') as $key => $lang)
                                                                    <li class="nav-item">
                                                                        <a class="nav-link @if ($loop->index == 0) show active in @endif"
                                                                           ...
                                                                           href="#{{ $key }}" role="tab"
                                                                           style="background-color: rgb(27, 197, 189) ;color: #ffffff;"
                                                                           aria-controls="home"
                                                                ...
                                                                @foreach (config('app.languages') as $key => $lang)
                                                                    <div
                                                                        ...
                                                                        <div class=" form-group">
                                                                            ...
                                                                            <textarea name="{{$key}}[title]" class="summernote form-control   @error('title') is-invalid @enderror"
                                                                                      id="kt_summernote_1"></textarea>
                                                                            @error('title')
                                                                        ...
                                                                        <div class=" form-group">
                                                                            ...
                                                                            <textarea name="{{$key}}[description]" class="summernote form-control   @error("description") is-invalid @enderror"
                                                                                      id="kt_summernote_1"></textarea>
                                                                            @error("description")
                                                                            <p class="invalid-feedback"> {{ $message }}</p>
                                                                            @enderror
