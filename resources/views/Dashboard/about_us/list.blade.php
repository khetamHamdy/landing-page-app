    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                ...
                <span class="text-muted font-weight-bold mr-4">{{__('About us')}} </span>
                @can('aboutus.create')
                <a href="{{route('about')}}" class="btn btn-light-warning font-weight-bolder btn-sm">{{__('Add')}} </a>
                @endcan
                <!--end::Actions-->
            </div>
            <!--end::Info-->
                ...
                <div class="col-xl-5 col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="card card-custom gutter-b card-stretch">
                        ...
                        <div class="card-body text-center pt-4">
                            ...
                            <!--begin::Buttons-->
                            @can('aboutus.update')
                            <form action="{{route('aboutDelete' , $data)}}" method="POST">
                                @csrf
                                @method('delete')
                                <br>
                                <button type="submit"
