<!DOCTYPE html>
<!--
Template Name: Metronic - Bootstrap 4 HTML, React, Angular 9 & VueJS dashboard DashboardLayout Theme
Author: KeenThemes
...
<head>
    ...
    <link href="{{asset('dashboard/css/pages/login/login-3.css')}}" rel="stylesheet" type="text/css" />
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="login login-3 login-signin-on d-flex flex-column flex-lg-row flex-row-fluid bg-white" id="kt_login">
        <!--begin::Aside-->
        <div class="login-aside d-flex flex-row-auto bgi-size-cover bgi-no-repeat p-10 p-lg-10" style="background-image: url('{{asset('dashboard/media/bg/bg-4.jpg')}}');">
            <!--begin: Aside Container-->
            <div class="d-flex flex-row-fluid flex-column justify-content-between">
                <!--begin: Aside header-->
                <a href="#" class="flex-column-auto mt-5">
                    <img src="{{asset('dashboard/media/logos/logo-letter-1.png')}}" class="max-h-70px" alt="" />
                </a>
                <!--end: Aside header-->
                <!--begin: Aside content-->
                <div class="flex-column-fluid d-flex flex-column justify-content-center">
                    <h3 class="font-size-h1 mb-5 text-white">Welcome to Metronic!</h3>
                    <p class="font-weight-lighter text-white opacity-80">The ultimate Bootstrap, Angular 8, React &amp; VueJS dashboard theme framework for next generation web apps.</p>
                </div>
                <!--end: Aside content-->
